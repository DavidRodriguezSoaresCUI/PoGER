...
\begin{enumerate}
	...
	Recommended way : Run the game within RPG Maker XP (press \verb|F12| or click on the arrow next to the note icon) and play until you can gain control of the character and save. Close the game. Then, create an event close to your character and add a script command with parameter \fbox{{\ttfamily pbSaveAll()}}. 
	
	"Fast" way : Find the initial event that runs when the game launches and add to it a script command with parameter \fbox{{\ttfamily pbSaveAll()}}.
