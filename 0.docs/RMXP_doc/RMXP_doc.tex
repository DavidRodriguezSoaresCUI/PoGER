...
\begin{tabular}{|c a l|}
	...
	& Parameters & [2] - \textbf{0}:texture file (no ext) \verb|[String]|, \ \textbf{1}:hue - unused, \ \textbf{2}:direction $d$ \verb|[integer]|, \ \textbf{3}:step \verb|[integer 0-3]| \\
	& Notes & \textit{step} is the horizontal offset (column), \textit{direction} is the vertical offset \\
	%& Representation & "TODO" \\
	\hline
